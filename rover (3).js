                            ...
                            var apiKey = '8UTAPS7mcouhcdrhkHgQblyALFHAg6NJm9Ox7oO3'; 
                              ...
                              document.getElementById('dateInput').addEventListener('click', function(event){
                                ...
                                request.addEventListener('load',function(){
                                 if(request.status >= 200 && request.status < 400){
                                    ...
                                    document.getElementById('nextbtn').setAttribute("href", "mars.html?image="+response.photos[0].img_src);
                                ...
                                document.getElementById('imageStatus').textContent = 'Sedang diproses atau Coba cek tanggal jika Gambar tidak muncul';
                                request.send(null);
